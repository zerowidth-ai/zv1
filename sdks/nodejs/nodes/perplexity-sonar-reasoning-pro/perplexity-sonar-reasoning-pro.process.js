export default async ({inputs, settings, config, nodeConfig}) => {
    try {
        ...
        throw new Error(`Perplexity: Sonar Reasoning Pro node error: ${error.message}`);
    }
};