export default async ({inputs, settings, config, nodeConfig}) => {
    try {
        ...
        throw new Error(`Qwen: Qwen3 VL 32B Instruct node error: ${error.message}`);
    }
};