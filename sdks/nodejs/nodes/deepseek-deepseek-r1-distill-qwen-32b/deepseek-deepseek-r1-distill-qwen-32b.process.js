export default async ({inputs, settings, config, nodeConfig}) => {
    try {
        ...
        throw new Error(`DeepSeek: R1 Distill Qwen 32B node error: ${error.message}`);
    }
};