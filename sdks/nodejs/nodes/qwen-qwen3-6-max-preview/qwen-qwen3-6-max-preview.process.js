export default async ({inputs, settings, config, nodeConfig}) => {
    try {
        ...
        throw new Error(`Qwen: Qwen3.6 Max Preview node error: ${error.message}`);
    }
};