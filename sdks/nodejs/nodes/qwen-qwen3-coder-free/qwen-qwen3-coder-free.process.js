export default async ({inputs, settings, config, nodeConfig}) => {
    try {
        ...
        throw new Error(`Qwen: Qwen3 Coder 480B A35B (free) node error: ${error.message}`);
    }
};