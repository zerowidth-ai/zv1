export default async ({inputs, settings, config, nodeConfig}) => {
    try {
        ...
        throw new Error(`OpenAI: GPT-5.1 Chat node error: ${error.message}`);
    }
};