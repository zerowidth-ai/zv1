export default async ({inputs, settings, config, nodeConfig}) => {
    try {
        ...
        throw new Error(`OpenAI: GPT-5 Image Mini node error: ${error.message}`);
    }
};