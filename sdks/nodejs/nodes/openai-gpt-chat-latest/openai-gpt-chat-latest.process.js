export default async ({inputs, settings, config, nodeConfig}) => {
    try {
        ...
        throw new Error(`OpenAI: GPT Chat Latest node error: ${error.message}`);
    }
};