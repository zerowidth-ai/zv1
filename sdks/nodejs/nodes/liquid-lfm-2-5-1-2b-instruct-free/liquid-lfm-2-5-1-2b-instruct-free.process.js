export default async ({inputs, settings, config, nodeConfig}) => {
    try {
        ...
        throw new Error(`LiquidAI: LFM2.5-1.2B-Instruct (free) node error: ${error.message}`);
    }
};