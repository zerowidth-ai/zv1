export default async ({inputs, settings, config, nodeConfig}) => {
    try {
        ...
        throw new Error(`OpenAI: GPT-3.5 Turbo Instruct node error: ${error.message}`);
    }
};