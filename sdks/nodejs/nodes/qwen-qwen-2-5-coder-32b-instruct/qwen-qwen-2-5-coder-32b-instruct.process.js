export default async ({inputs, settings, config, nodeConfig}) => {
    try {
        ...
        throw new Error(`Qwen2.5 Coder 32B Instruct node error: ${error.message}`);
    }
};