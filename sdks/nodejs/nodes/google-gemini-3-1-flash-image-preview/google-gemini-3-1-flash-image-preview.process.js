export default async ({inputs, settings, config, nodeConfig}) => {
    try {
        ...
        throw new Error(`Google: Nano Banana 2 (Gemini 3.1 Flash Image Preview) node error: ${error.message}`);
    }
};