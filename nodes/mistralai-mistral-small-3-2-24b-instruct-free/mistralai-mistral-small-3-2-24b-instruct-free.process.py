async def process(inputs, settings, config, nodeConfig):
    """Process function for the Mistral: Mistral Small 3.2 24B (free) node"""
    try:
        ...
        raise Exception(f"Mistral: Mistral Small 3.2 24B (free) node error: {str(e)}")