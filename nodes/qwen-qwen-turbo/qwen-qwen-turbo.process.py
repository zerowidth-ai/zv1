async def process(inputs, settings, config, nodeConfig):
    """Process function for the Qwen: Qwen-Turbo node"""
    try:
        ...
        raise Exception(f"Qwen: Qwen-Turbo node error: {str(e)}")