async def process(inputs, settings, config, nodeConfig):
    """Process function for the Qwen: Qwen3 4B (free) node"""
    try:
        ...
        raise Exception(f"Qwen: Qwen3 4B (free) node error: {str(e)}")