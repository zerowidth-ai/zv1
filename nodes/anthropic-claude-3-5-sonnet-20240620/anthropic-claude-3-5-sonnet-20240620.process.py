async def process(inputs, settings, config, nodeConfig):
    """Process function for the Anthropic: Claude 3.5 Sonnet (2024-06-20) node"""
    try:
        ...
        raise Exception(f"Anthropic: Claude 3.5 Sonnet (2024-06-20) node error: {str(e)}")