async def process(inputs, settings, config, nodeConfig):
    """Process function for the Google: Gemma 2 27B node"""
    try:
        ...
        raise Exception(f"Google: Gemma 2 27B node error: {str(e)}")