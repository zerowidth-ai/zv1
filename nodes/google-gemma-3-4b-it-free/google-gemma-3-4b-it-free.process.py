async def process(inputs, settings, config, nodeConfig):
    """Process function for the Google: Gemma 3 4B (free) node"""
    try:
        ...
        raise Exception(f"Google: Gemma 3 4B (free) node error: {str(e)}")