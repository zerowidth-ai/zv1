async def process(inputs, settings, config, nodeConfig):
    """Process function for the Qwen: Qwen3 30B A3B Instruct 2507 node"""
    try:
        ...
        raise Exception(f"Qwen: Qwen3 30B A3B Instruct 2507 node error: {str(e)}")