async def process(inputs, settings, config, nodeConfig):
    """Process function for the DeepSeek: Deepseek R1 0528 Qwen3 8B (free) node"""
    try:
        ...
        raise Exception(f"DeepSeek: Deepseek R1 0528 Qwen3 8B (free) node error: {str(e)}")