async def process(inputs, settings, config, nodeConfig):
    """Process function for the OpenAI: o3 Mini High node"""
    try:
        ...
        raise Exception(f"OpenAI: o3 Mini High node error: {str(e)}")