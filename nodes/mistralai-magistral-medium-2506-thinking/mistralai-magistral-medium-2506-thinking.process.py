async def process(inputs, settings, config, nodeConfig):
    """Process function for the Mistral: Magistral Medium 2506 (thinking) node"""
    try:
        ...
        raise Exception(f"Mistral: Magistral Medium 2506 (thinking) node error: {str(e)}")