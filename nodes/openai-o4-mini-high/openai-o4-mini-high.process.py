async def process(inputs, settings, config, nodeConfig):
    """Process function for the OpenAI: o4 Mini High node"""
    try:
        ...
        raise Exception(f"OpenAI: o4 Mini High node error: {str(e)}")